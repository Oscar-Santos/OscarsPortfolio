...
//               </div>
//               <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
//                   <img className='w-20 mx-auto' src={Openai} alt="HTML icon" />
...
//               </div>
//               <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
//                   <img className='w-[4.3rem] mx-auto' src={Linux} alt="HTML icon" />
...
//                </div>
//                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
//                    <img className='w-20 mx-auto' src={GitHub} alt="HTML icon" />/                   <p className='my-4'>GITHUB</p>
//                </div>
//                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
//                    <img className='w-20 mx-auto' src={Node} alt="HTML icon" />
//                    <p className='my-4'>NODE JS</p>
...
//                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
//                    <img className='w-20  mx-auto' src={Postman} alt="HTML icon" />
//                    <p className='my-4'>POSTMAN</p>               </div>
//                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
//                    <img className='w-[4.3rem] mx-auto' src={Linux} alt="HTML icon" />
//                    <p className='my-4'>LINUX</p>
//                </div>
